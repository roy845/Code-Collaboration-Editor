...
const ConfirmDeleteUserModal: React.FC<ConfirmDeleteRoomModalProps> = ({
  confirmationText,
  setConfirmationText,
  isDeleting,
  onCancel,
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 max-w-md w-full">
        ...
        <p className="text-gray-400 mb-4">
          ...
          <strong className="text-white">"Delete User"</strong> in the input
          below.
        </p>
        <input
          type="text"
          ...
          placeholder="Type 'Delete User' here"
        ...
        <div className="flex justify-between gap-4 mt-6">
          ...
          <button
            onClick={onDelete}
            disabled={confirmationText !== "Delete User" || isDeleting}
            className={`px-4 py-2 rounded-lg ${
              confirmationText !== "Delete User" || isDeleting
